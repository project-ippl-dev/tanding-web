import { ClubFetchAllData, ClubFetchInviteRequestData, ClubFetchJoinRequestData, ClubFetchMemberData, ClubFetchOneData } from "@/types/club.type";
import { FetchResponseBody } from "@/types/global";

export const CLUB_ALL_DATA: FetchResponseBody<ClubFetchAllData[]> = {
...
export const CLUB_ONE_DATA: FetchResponseBody<ClubFetchOneData> = {
...
export const CLUB_JOIN_DATA: FetchResponseBody<ClubFetchJoinRequestData[]> = {
...
export const CLUB_INVITE_DUMMY: ClubFetchInviteRequestData[] = [
  {
    id: 1,
    name: "Club 1",
