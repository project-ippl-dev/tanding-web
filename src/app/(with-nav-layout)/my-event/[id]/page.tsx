...
import { TOURNAMENT_DETAIL } from "@/store/tournament";
...
const OwnTournamentDetail = () => {
  ...
  useEffect(() => {
    ...
    if (typeof params.id === "string") {
      if (process.env.NEXT_PUBLIC_OFFLINE_PAYLOAD === "true") setTournament(TOURNAMENT_DETAIL);
      else fetchTournamentDetail(params.id);
    }
  }, [params.id]);
  ...
  const MemoizeParticipant = React.memo(() => {
      return <Participant />;
    });
  MemoizeParticipant.displayName = "MemoizeParticipant";
